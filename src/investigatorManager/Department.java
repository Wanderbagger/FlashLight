...
public enum Department {
    ...
    BASMANNIY_PI ("Басманный", Prosecutor.BASMANNAYA_PROSECUTORS_OFFICE, Court.BASMANNIY_COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
    KRASNOSELSKIY_PI ("Красносельский", Prosecutor.MESHANSKAYA_PROSECUTORS_OFFICE, Court.MESHANSKIY_COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
    MESHANSKIY_PI ("Мещанский", Prosecutor.MESHANSKAYA_PROSECUTORS_OFFICE, Court.MESHANSKIY_COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
    PRESNENSKIY_PI ("Пресненский", Prosecutor.PRESNENSKAYA_PROSECUTORS_OFFICE, Court.PRESNENSKIY_COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
    ARBAT_PI ("Арбат", Prosecutor.PRESNENSKAYA_PROSECUTORS_OFFICE, Court.PRESNENSKIY_COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
    ZAMOSKVORECHYE_PI ("Замоскворечье", Prosecutor.ZAMOSKVORECKAYA_PROSECUTORS_OFFICE, Court.ZAMOSKVORECKIY__COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
    ...
    YAKIMANKA_PI ("Якиманка",	Prosecutor.ZAMOSKVORECKAYA_PROSECUTORS_OFFICE, Court.ZAMOSKVORECKIY__COURT, DepartmentType.POLICE_INVESTIGATION_TERRITORIAL, District.CENTRAL),
